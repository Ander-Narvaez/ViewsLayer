...
namespace ViewsLayer.ServiceReference {
    ...
    public interface WebServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string MaintenanceEmpleados(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/MaintenanceEmpleados", ReplyAction="*")]
        System.Threading.Tasks.Task<string> MaintenanceEmpleadosAsync(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetListEmpleados", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Data.DataSet GetListEmpleados(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetListEmpleados", ReplyAction="*")]
        System.Threading.Tasks.Task<System.Data.DataSet> GetListEmpleadosAsync(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION);
    ...
    public partial class WebServiceSoapClient : System.ServiceModel.ClientBase<ViewsLayer.ServiceReference.WebServiceSoap>, ViewsLayer.ServiceReference.WebServiceSoap {
        ...
        public System.Threading.Tasks.Task<string> MaintenanceEmpleadosAsync(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION) {
            return base.Channel.MaintenanceEmpleadosAsync(pEMPRESA, pSUCURSAL, pCEDULA, pNOMBRE, pAPELLIDOS, pEMAIL, pTELEFONO, pACCION);
        }
        
        public System.Data.DataSet GetListEmpleados(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION) {
            return base.Channel.GetListEmpleados(pEMPRESA, pSUCURSAL, pCEDULA, pNOMBRE, pAPELLIDOS, pEMAIL, pTELEFONO, pACCION);
        }
        
        public System.Threading.Tasks.Task<System.Data.DataSet> GetListEmpleadosAsync(string pEMPRESA, string pSUCURSAL, string pCEDULA, string pNOMBRE, string pAPELLIDOS, string pEMAIL, string pTELEFONO, string pACCION) {
