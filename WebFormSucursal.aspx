<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="WebFormSucursal.aspx.cs" Inherits="ViewsLayer.Views.WebFormSucursal" %>
    ...
    <div class="row mb-3 ">
        ...
        <div class="col-12 justify-content-center align-items-center p-4">
            <div class=" " style="width: 100%; height: 200px; overflow: scroll">
                ...
                <asp:GridView ID="tbl" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="True" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblSucursal_SelectedIndexChanged">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Registro Sucursales</h5>
                        <%-- Titulo del modal--%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        ...
                                        <asp:TextBox ID="txtSUCURSAL" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%--  NOMBRE--%>
                                <div class="col-12 d-flex flex-column mt-3">
