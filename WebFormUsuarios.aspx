<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebFormUsuarios.aspx.cs" Inherits="ViewsLayer.WebFormUsuarios" %>
    ...
    <div class="row mb-3 ">
        ...
        <div class="col-12 justify-content-center align-items-center p-4">
            <div class=" " style="width: 100%; height: 200px; overflow: scroll">
                ...
                <asp:GridView ID="tbl" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="True" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblUsuarios_SelectedIndexChanged">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        ...
                                        <asp:TextBox ID="txtID" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%-- USUARIO --%>
                                <div class="col-12 d-flex flex-column mt-3">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblcontra" runat="server" Text="Contraseña" CssClass="" ToolTip="" Width="100px"></asp:Label>
                                        <asp:TextBox ID="txtCONTRA" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%-- TIPO --%>
                                <div class="col-12 d-flex flex-column mt-3">
