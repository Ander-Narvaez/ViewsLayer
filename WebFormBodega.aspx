<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebFormBodega.aspx.cs" Inherits="ViewsLayer.WebFormBodega" %>
    ...
    <div class="row mb-3 ">
        ...
        <div class="col-12 justify-content-center align-items-center p-4">
            <div class=" " style="width: 100%; height: 200px; overflow: scroll">
                ...
                <asp:GridView ID="tbl" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="True" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblBodega_SelectedIndexChanged">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Registro Bodega</h5>
                        <%-- Titulo del modal--%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        ...
                                        <asp:DropDownList ID="txtInventario" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:DropDownList>
                                    </div>
                                </div>
                                <%-- NOMBRE  --%>
                                <div class="col-12 d-flex flex-column mt-3">
