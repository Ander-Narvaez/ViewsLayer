<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebFormProveedores.aspx.cs" Inherits="ViewsLayer.WebFormProveedores" %>
    ...
    <div class="row mb-3 ">
        ...
        <div class="col-12 justify-content-center align-items-center p-4">
            <div class=" " style="width: 100%; height: 200px; overflow: scroll">
                ...
                <asp:GridView ID="tbl" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="True" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblProveedores_SelectedIndexChanged">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Registro Proveedores</h5>
                        <%-- Titulo del modal--%>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblcedula_juridica" runat="server" Text="Cedula Juridica" CssClass="" ToolTip="" Width="100px"></asp:Label>
                                        <asp:TextBox ID="txtCedula_juridica" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%--  RAZON SOCIAL --%>
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblrazon_social" runat="server" Text="Razón Social" CssClass="" ToolTip="" Width="100px"></asp:Label>
                                        <asp:TextBox ID="txtRazon_social" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%-- UBICACION --%>
                                <div class="col-12 d-flex flex-column mt-3">
