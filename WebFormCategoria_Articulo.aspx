<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebFormCategoria_Articulo.aspx.cs" Inherits="ViewsLayer.WebFormCategoria_Articulo" %>
    ...
    <div class="row mb-3 ">
        <div class="col-12 " style="left: 0px; top: 0px">
            <div class="col-form-label">
                <h4>Lista de Categoria Articulo</h4>
                <%-- Listar objetos--%>
            </div>
        </div>
        ...
        <div class="col-12 justify-content-center align-items-center p-4">
            <div class=" " style="width: 100%; height: 200px; overflow: scroll">
                ...
                <asp:GridView ID="tbl" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="True" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblCategoria_Articulo_SelectedIndexChanged">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Registro Categoria Articulo</h5>
                        <%-- Titulo del modal--%>
